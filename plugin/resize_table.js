class ResizeTablePlugin extends BasePlugin {
  style = () => this.config.REMOVE_MIN_CELL_WIDTH ? "table.md-table td { min-width: 1px !important; }" : undefined
  ...
  getDynamicActions = () => [{ act_value: "record_resize_state", act_state: this.config.RECORD_RESIZE, act_name: this.i18n.t("$label.RECORD_RESIZE") }]
