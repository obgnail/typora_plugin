class RightOutlinePlugin extends BasePlugin {
  ...
  html = () => {
    ...
    return `
      <div id="plugin-right-outline" class="plugin-common-panel plugin-common-hidden">
