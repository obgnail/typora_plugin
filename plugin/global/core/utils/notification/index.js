class Notification {
  ...
  process = async () => {
    this.utils.insertStyleFile("common-notification", "./plugin/global/core/utils/notification/index.css")
    this.utils.insertElements(`<div class="plugin-common-notification-container"></div>`)
  }
