class textStylizePlugin extends BasePlugin {
    ...
    genToolbarHTML = () => {
        const toolMap = {
            ...
            size: ["尺寸", `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M560-160v-520H360v-120h520v120H680v520H560Zm-360 0v-320H80v-120h360v120H320v320H200Z"/></svg>`],
    ...
    setStyle = ({toggleMap, deleteMap, mergeMap, upsertMap, replaceMap, moveBookmark = true, rememberFormat = false}) => {
